// Inline SVG icon set (feather-style, 24px, currentColor stroke).
...
export const icons = {
  ...
  live: S('<path d="M12 2v20"/><path d="M5 7v10"/><path d="M19 7v10"/><path d="M8.5 4v16"/><path d="M15.5 4v16"/>'),
  analyze: S('<path d="M3 12h3l2-7 4 14 3-9 2 4h4"/>'),
  map: S('<polygon points="1 6 8 3 16 6 23 3 23 18 16 21 8 18 1 21"/><line x1="8" y1="3" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="21"/>'),
  projects: S('<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>'),
  species: S('<path d="M12 3c-2-4-7-4-9-1 2 1 2.5 3 2 5-3-1-5 1-5 3 3-1 4 1 6 3s4 3 6 3 4-1 6-3 3-4 6-3c0-2-2-4-5-3-.5-2 0-4 2-5-2-3-7-3-9 1z"/>'),
  reports: S('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/>'),
  ...
  mic: S('<path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/>'),
  ...
  station: S('<path d="M5 12.55a11 11 0 0 1 14.08 0"/><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><line x1="12" y1="20" x2="12.01" y2="20"/>'),
  thermometer: S('<path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"/>'),
  battery: S('<rect x="1" y="6" width="18" height="12" rx="2"/><line x1="23" y1="10" x2="23" y2="14"/>'),
  ...
  wave: S('<path d="M2 12h2l2-6 4 16 4-20 3 14 2-4h3"/>'),
